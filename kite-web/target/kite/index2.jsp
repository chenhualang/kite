				...
				<nav class="navbar navbar-default">
					...
					<div class="navbar-header">
					  <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
						...
						<div class="logo">
							<a class="navbar-brand" href="index.jsp">Deliccio <span>大可美食馆</span></a>
						</div>
					</div>
					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
					 <ul class="nav navbar-nav">
						...
						<li><a href="services.html">订单管理</a></li>
						<li><a href="typo.html">用户管理</a></li>
												...
												<div class="ckeck-bg">
													<div class="checkbox-form">
														<div class="check-left">
															<div class="check">
																<label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i> </i>下次登录</label>
															</div>
															<div class="check">
...
<!-- welcome -->
	<div class="welcome">
		<div class="container">
			...
			<p class="proident">每次满怀期待打开鳗鱼饭盒的一瞬间，香气扑面而来，眼前金黄一片.</p>
...
<!--footer-->
		...
		<div class="container">
			<div class="footer-row">
				...
				<div class="col-md-3 footer-grids">
					...
					<p>你想要的都在这里！ <p>
					<form>
					    <input type="text" class="text" value="want you" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'want you';}">
	...
	<div class="footer-bottom">
		<div class="container">
			<p>Copyright &copy; 2015.Company name All rights reserved.More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="#" title="大可美食馆" target="_blank">大可美食</a></p>
		</div>
	</div>
<!--//footer-->
